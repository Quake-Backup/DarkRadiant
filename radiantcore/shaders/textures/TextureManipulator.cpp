...
const std::string TextureManipulator::RKEY_TEXTURES_QUALITY = "user/ui/textures/quality";
const std::string TextureManipulator::RKEY_TEXTURES_GAMMA = "user/ui/textures/gamma";
