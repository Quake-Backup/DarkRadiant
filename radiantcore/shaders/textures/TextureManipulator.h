...
/// Helper object for resizing textures, owned and managed by the MaterialManager
...
public:
    ...
    // Registry keys
    static const std::string RKEY_TEXTURES_QUALITY;
    static const std::string RKEY_TEXTURES_GAMMA;
